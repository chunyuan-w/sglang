...
class DeepseekV2MoE(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        ...
        if (
            ...
            and self.gate.use_intel_amx_backend
            and self.experts.use_intel_amx_backend
            and self.shared_experts_gate_up_proj.use_intel_amx_backend
            and self.shared_experts_down_proj.use_intel_amx_backend
        ):
