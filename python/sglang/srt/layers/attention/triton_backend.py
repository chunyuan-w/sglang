...
class TritonAttnBackend(AttentionBackend):
    def __init__(
        ...
        print(f"my attn device: {model_runner.device}, {model_runner.gpu_id}")
        self.device_core_count = get_device_core_count(model_runner.gpu_id) if self.device != "cpu" else 0
